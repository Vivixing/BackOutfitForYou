...
@routerVisualizacion.get("/user/{usuarioId}")
async def get_visualizaciones_by_user(usuarioId: PydanticObjectId):
    return await VisualizacionController.obtenerVisualizacionesPorUsuario(usuarioId)